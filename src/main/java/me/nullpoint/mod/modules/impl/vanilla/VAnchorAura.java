...
public class VAnchorAura extends Module  {
    ...
    public final SliderSetting range =
            add(new SliderSetting("Range", 5.0, 0.0, 100.0, 0.1, v -> page.getValue() == Page.General).setSuffix("m"));
    public final SliderSetting targetRange =
            add(new SliderSetting("TargetRange", 8.0, 0.0, 100.0, 0.1, v -> page.getValue() == Page.General).setSuffix("m"));
    ...
    double fade = 0;
    public VAnchorAura() {
        super("VAnchorAura", Category.Combat);
        INSTANCE = this;
    ...
    public void anchor() {
        ...
        if (tempPos != null) {
            ...
            if (breakCrystal.getValue()) {
                TPUtil.tp(() -> CombatUtil.attackCrystal(new BlockPos(tempPos), rotate.getValue(), false), tempPos.toCenterPos());
    ...
    public void clickBlocks(BlockPos pos, Direction side, boolean rotate) {
        ...
        if (mc.interactionManager != null) {
            TPUtil.tp(() -> mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, result), pos.toCenterPos());
