...
public class Isolation extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(station, (mouseX - width) / 48, 30+(mouseY-height/2)/80, 0, 0, 0, width, height, width, height);
       //fw gun ok? context.drawTexture(pillar, (mouseX - width) / 64, 0, 0, 0, 0, width, height, width, height);
       ...
       //todo 通过alphaFac在鼠标离按钮远的时候降低按钮透明度
        ...
        if(zoomSingle > 1) {
            ...
            matrices.scale((float)zoomSingle,zoomSingle, 1);
            matrices.translate(-(startX + buttonWidth), -(buttonY + buttonWidth), 0);
            TextUtil.drawStringWithScale(context,"Singleplayer", (float) (startX  +buttonWidth/2-TextUtil.getWidth("Singleplayer")), (float) buttonY+buttonWidth+1, new Color(255 ,255 ,255,255).getRGB(),2f);
        }
        matrices.pop();
        ...
        if(zoomMulti > 1) {
            matrices.translate(startX + buttonWidth, buttonY + buttonWidth, 0);
            matrices.scale((float)zoomMulti,zoomMulti, 1);
            matrices.translate(-(startX + buttonWidth), -(buttonY + buttonWidth), 0);
            TextUtil.drawStringWithScale(context,"Multiplayer", (float) (startX+buttonWidth/2-TextUtil.getWidth("Multiplayer")), (float) buttonY+buttonWidth+1, new Color(255 ,255 ,255,255).getRGB(),2f);
        }
        matrices.pop();
        startX += (int) (buttonWidth + 0.2 * buttonWidth + charc);
        ...
        if(zoomSetting > 1) {
            matrices.translate(startX + buttonWidth, buttonY + buttonWidth, 0);
            matrices.scale((float)zoomSetting,zoomSetting, 1);
            matrices.translate(-(startX + buttonWidth), -(buttonY + buttonWidth), 0);
            TextUtil.drawStringWithScale(context,"Setting", (float) (startX+buttonWidth/2-TextUtil.getWidth("Setting")), (float) buttonY+buttonWidth+1, new Color(255 ,255 ,255,255).getRGB(),2f);
        }
        matrices.pop();
        startX += (int) (buttonWidth + 0.2 * buttonWidth + charc);
        ...
        if(zoomExit > 1) {
            matrices.translate(startX + buttonWidth, buttonY + buttonWidth, 0);
            matrices.scale((float)zoomExit,zoomExit, 1);
            matrices.translate(-(startX + buttonWidth), -(buttonY + buttonWidth), 0);
            TextUtil.drawStringWithScale(context,"Exit", (float) (startX +buttonWidth/2-TextUtil.getWidth("Exit")-2), (float) buttonY+buttonWidth+1, new Color(255 ,255 ,255,255).getRGB(),2f);
        }
        matrices.pop();
